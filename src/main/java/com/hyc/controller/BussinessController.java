...
public class BussinessController {
    ...
    @GetMapping("/buss/selectUser")
    public String selectUser(Long userId) {
        User user = bussinessService.selectById(userId);
        return JSONObject.toJSONString(user);
    }


    @GetMapping("/buss/selectByAge")
    public String selectUser(int age) {
        List<User> users = bussinessService.selectByAge(age);
